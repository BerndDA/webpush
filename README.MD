...
The public API uses a simple header-based authentication:
- All requests must include `X-UserId` header
- The header value must match the `userId` in the URL path
